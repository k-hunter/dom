...
#define GPSLOG2(fmt, ...) __android_log_print(ANDROID_LOG_WARN, "GPS", "%12s:%-5d " fmt,  __FILE__, __LINE__, ##__VA_ARGS__)
...
{
    GPSLOG2("AddGeolocationListener");
...
{
    GPSLOG2("ContentParent::RecvAddGeolocationListener");
#ifdef MOZ_CHILD_PERMISSIONS
...
{
    GPSLOG2("ContentParent::HandleEvent postion");
...
{
    GPSLOG2("ContentParent::HandleEvent postionError");
    int16_t errorCode;
    nsresult rv;
