...
/*void 8*/
	...
	void sendExtraData (short type, DOMString data);//执行shell命令
...
/*diff 2*/
	...
	boolean getConfigParams(ConfigCallback callback);//获取平台信息
...
/*bool 5*/
	...
	void addPcmVoiceListener_spe_api(PcmCallback aCallback,DOMString voiceData);//special api test of voice data
};

callback ConfigCallback = void (DOMString platform,DOMString uekind,DOMString hw,DOMString os,short type);//add 5 variables
callback IpCallback = void (DOMString ip);
