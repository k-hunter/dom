...
MozInputMethod.prototype = {
  ...
  receiveMessage: function mozInputMethodReceiveMsg(msg) {
    dump("keylog======= MozKeyboard.js mozInputMethodReceiveMsg msg.name="+msg.name);
    if (msg.name.startsWith('Keyboard') &&
        !WindowMap.isActive(this._window)) {
      dump("keylog======= MozKeyboard.js mozInputMethodReceiveMsg no win active return");
      return;
    }
    ...
    switch(msg.name) {
      ...
      case 'Keyboard:ReceiveHardwareKeyEvent':
        ...
        dump("keylog======= MozKeyboard.js cpmmSendAsyncMessageWithKbID");
...
InputContextDOMRequestIpcHelper.prototype = {
  ...
  receiveMessage: function(msg) {
    dump("keylog======= MozKeyboard.js receiveMessage22");
    if (!this._inputContext) {
...
MozInputContext.prototype = {
  ...
  receiveMessage: function ic_receiveMessage(msg) {
    dump("keylog======= MozKeyboard.js receiveMessage11");
    if (!msg || !msg.json) {
